...
DESTDIR ?= /usr/local
RAYLIB_INSTALL_PATH ?= /home/m/development/raylib
# RAYLIB_H_INSTALL_PATH locates the installed raylib header and associated source files.
RAYLIB_H_INSTALL_PATH ?= /home/m/development/raylib/src
...
ifeq ($(PLATFORM),PLATFORM_DESKTOP)
    ifeq ($(PLATFORM_OS),LINUX)
        RAYLIB_PREFIX ?= ..
        RAYLIB_PATH    = /home/m/development/raylib
    endif
endif
...
ifeq ($(PLATFORM),PLATFORM_WEB)
    ...
    CFLAGS += -s USE_GLFW=3 -s ASYNCIFY -s TOTAL_MEMORY=16777216 -s FORCE_FILESYSTEM=1 
...
PROJECT_SOURCE_FILES ?= simple_game.cpp
